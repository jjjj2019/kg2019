...
<body>
    ...
    <script>
    	...
    	$("#idConfirmBtn").click(function() {
    		...
    		//아이디가 존재하면 1을반환, 아이디가 존재하지 않는다면 0을반환
    		//아이디가 존재하지 않는다면 "사용가능한 아이디입니다"를 출력하고, 아이디를 바꾸지 못하도록 readonly처리. msgId에 "사용가능한 아이디입니다"를 문자열로 추가
    		//어아디가 존재한다면 "중복된 아이디입니다"를 출력 userId에 포커스
    		var userId = $("#userId").val(); //아이디 얻음
    		$.ajax({
    			type:"post",
    			url:"idConfirm",
