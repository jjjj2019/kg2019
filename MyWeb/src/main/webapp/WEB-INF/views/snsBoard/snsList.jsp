...
<body>
			...
			<div class="row">
				<aside class="col-sm-2">
					<div class="aside-inner">
						<div class="menu1">
							<p>
								<img src="../resources/img/profile.png">스프링
							</p>
							<ul>
								<li>내정보</li>
								<li>내쿠폰</li>
	...
	<script>
		$(document).ready(function(){
			...
			function regist(){
				//alert("등록!") //이걸로 click, function regist()작동하는 지 확인했음
				...
				if(file != "jpg" && file != "png" && file != "bmp") {
					alert("이미지파일(jpg,png,bmp)만 등록 가능합니다");
				...
				$.ajax({
					...
					contentType: false, //ajax에서 false로 처리하면 "multipart/form-data"형식으로
					success:function(result) {
						//success가 돌아오면
						//파일업로드 태그값을 비우기
						//글영역 태그 비우기
						//미리보기 영역 display none을 통해 숨기기
						//getList(true) 스크립트 함수 호출
